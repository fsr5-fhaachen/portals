            ...
            <table class="table">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <Link
                      :href="'/tutor/group/' + group.id + '/join'"
                      method="post"
                      class="btn btn-danger text-white"
                      >Gruppe beitreten</Link
                    >
                    <Link
                      :href="'/tutor/group/' + group.id"
            ...
            <table class="table">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    <Link
                      :href="'/tutor/station/' + station.id + '/join'"
                      method="post"
                      class="btn btn-danger text-white"
                      >Station beitreten</Link
                    >
                    <Link
                      :href="'/tutor/station/' + station.id"
                      class="btn btn-primary text-white"
                      >Details</Link
                    >
                  </td>
